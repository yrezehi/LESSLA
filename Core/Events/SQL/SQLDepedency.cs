...
namespace Core.Events.SQL
{
    ...
    /*
     * Source is https://github.com/dyatchenko/ServiceBrokerListener/tree/master/ServiceBrokerListener/ServiceBrokerListener.Domain
     */

    public sealed class SQLDepedency : IDisposable
    {
        [Flags]
